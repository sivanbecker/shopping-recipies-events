    ...
    >
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-lg font-bold text-gray-900">{t('sharing.title')}</h2>
          <button
            onClick={onClose}
              ...
              {members.map(member => (
                <li key={member.id} className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="rounded-lg border border-gray-200 bg-gray-50 px-2 py-1 text-xs text-gray-700 focus:border-brand-400 focus:outline-none focus:ring-1 focus:ring-brand-100"
                  >
        ...
        <div>
          ...
          <input
            ...
            className="mb-2 w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
            autoComplete="email"
          />
          ...
          <div className="flex gap-2">
            <select
              ...
              className="rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-700 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-100"
            >
              <option value="editor">{t('sharing.roleEditor')}</option>
              <option value="viewer">{t('sharing.roleViewer')}</option>
            </select>
